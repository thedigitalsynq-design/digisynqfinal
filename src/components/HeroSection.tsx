    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto mb-12">
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold text-[var(--text-primary)] tracking-tight leading-[1.08] font-sans">
          ...
          <p className="mt-6 text-lg sm:text-xl text-[var(--text-secondary)] font-normal leading-relaxed max-w-3xl mx-auto">
          ...
          <p className="mt-3 text-sm sm:text-base text-[var(--text-tertiary)] max-w-2xl mx-auto leading-normal">
        ...
        >
          <div className="max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 text-xs font-mono uppercase tracking-widest text-[#E5A919] mb-3">
