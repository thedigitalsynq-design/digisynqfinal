    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#4D8DFF]/10 border border-[#4D8DFF]/25 text-[#4D8DFF] text-xs font-mono tracking-widest mb-4 font-semibold">
            <Layers className="w-3.5 h-3.5" />
            <span>Searchable Capability Index</span>
          </div>

          <h2 className="text-3xl sm:text-5xl font-extrabold text-[var(--text-primary)] tracking-tight leading-tight font-display">
            Explore DigiSynq
          </h2>
        ...
        <div className="ds-card rounded-3xl p-5 sm:p-7 mb-10 shadow-lg space-y-5">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-white/[0.04] border border-white/[0.10] rounded-2xl pl-11 pr-10 py-3 text-sm text-white placeholder-white/30 focus:outline-none focus:border-[#4D8DFF]/80 focus:ring-2 focus:ring-[#4D8DFF]/20 transition-all font-sans"
